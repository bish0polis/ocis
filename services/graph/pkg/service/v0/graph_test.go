				...
				"value":[
					{
						...
						"id":"pro-1$sameID!sameID",
						"name":"aspacename",
						"root":{
							"id":"pro-1$sameID!sameID",
							"webDavUrl":"https://localhost:9200/dav/spaces/pro-1$sameID%21sameID"
						}
					}
				]
			}
				...
				"value":[
					{
						...
						"driveType":"aspacetype",
						"id":"pro-1$asameID!asameID",
						"name":"aspacename",
						"root":{
							"eTag":"101112131415",
							"id":"pro-1$asameID!asameID",
							"webDavUrl":"https://localhost:9200/dav/spaces/pro-1$asameID%21asameID"
						}
					},
					{
						"driveAlias":"bspacetype/bspacename",
						"driveType":"bspacetype",
						"id":"pro-1$bsameID!bsameID",
						"name":"bspacename",
						"root":{
							"eTag":"123456789",
							"id":"pro-1$bsameID!bsameID",
							"webDavUrl":"https://localhost:9200/dav/spaces/pro-1$bsameID%21bsameID"
						}
					}
				]
			}
